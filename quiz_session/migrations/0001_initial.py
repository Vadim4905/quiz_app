# Generated by Django 5.0.7 on 2024-12-15 15:29

import django.core.validators
import django.db.models.deletion
import quiz_session.fields
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', quiz_session.fields.UniqueRandomCode(unique=True, validators=[django.core.validators.MaxValueValidator(999999), django.core.validators.MinValueValidator(100000)])),
                ...
                ('current_question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='quiz.question')),
